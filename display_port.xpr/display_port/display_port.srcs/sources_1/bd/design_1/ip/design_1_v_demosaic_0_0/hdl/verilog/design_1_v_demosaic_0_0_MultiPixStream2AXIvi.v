...
always @ (posedge ap_clk) begin
    if (((icmp_ln213_reg_308 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    ap_block_state4_io = ((icmp_ln213_reg_308 == 1'd0) & (m_axis_video_TREADY_int == 1'b0));
end
...
always @ (*) begin
    ap_block_state5_io = ((icmp_ln213_reg_308_pp0_iter1_reg == 1'd0) & (m_axis_video_TREADY_int == 1'b0));
end
